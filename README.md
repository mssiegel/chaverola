...
> with the transcript surviving a refresh — and **the teacher reads it
> all live**, every line under the sender's real name, on the host page's
> chat cards. "End chat", pausing, and the name reveal are honest
