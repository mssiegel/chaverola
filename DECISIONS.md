...
- [Teacher activity setup](docs/decisions/teacher-setup.md)
  - [On a phone, picking a character's emoji is a bottom sheet, not a popover](docs/decisions/teacher-setup.md#on-a-phone-picking-a-characters-emoji-is-a-bottom-sheet-not-a-popover)
